  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-cc-muted">
        Select a passage to comment, or inspect and edit the saved attachments. This preview changes only local fixture
        state.
      </p>
      <div ref={root} className="rounded-2xl border border-cc-border bg-cc-card p-4 space-y-4">
        <div data-message-id="annotation-example" data-message-role="assistant">
